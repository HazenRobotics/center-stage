...
public class Intake {
    ...
    IntakeDeploymentWheel deployment;
    ...
    public Intake(HardwareMap hw, Telemetry t, String motorName, String firstColorSensorName, String secondColorSensorName, String breakBeamSensorName, String deploymentWheelName) {
        ...
        deployment = new IntakeDeploymentWheel(hw, t, deploymentWheelName);
        telemetry = t;
    }
