...
public class AprilTagTuner extends OpMode {
    ...
    public void init() {
        ...
        bestConfigs.add(STARTING_CONFIG); bestConfigs.add(STARTING_CONFIG);
    ...
    public void loop() {
        if(inTuneMode) {
            ...
            if(inNegativeMode) currentConfig[configIndex]-=STEP_AMOUNT/testNumber; else currentConfig[configIndex]+=STEP_AMOUNT/testNumber;
