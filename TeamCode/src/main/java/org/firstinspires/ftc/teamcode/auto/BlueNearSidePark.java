...
public class BlueNearSidePark extends LinearOpMode {
	...
	public void runOpMode( ) throws InterruptedException {
		...
		robot.roadrunnerDrive.getLocalizer().setPoseEstimate( new Pose2d(10,61.5, Math.toRadians( 270 ) ));
		...
		robot.roadrunnerDrive.followTrajectorySequence( robot.roadrunnerDrive.trajectorySequenceBuilder(new Pose2d(10,61.5, Math.toRadians( 270 )))
				.lineTo(new Vector2d( 59, 61.5 ), KhepriSwerveDrive.getVelocityConstraint( 30, 180, 17.4 ), KhepriSwerveDrive.getAccelerationConstraint( 30 ))
				.build() );
	}
}
